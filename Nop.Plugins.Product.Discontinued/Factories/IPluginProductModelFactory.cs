...
namespace Nop.Plugin.Product.Discontinued.Factories
{
    ...
    /// </summary>
    public interface IPluginProductModelFactory
    {
        /// <summary>
        ...
        ProductModel PrepareProductModel(ProductModel model, Core.Domain.Catalog.Product product, bool excludeProperties = false);
        ProductDiscontinuedModel PreparePluginProductModel(ProductDiscontinuedModel model, Core.Domain.Catalog.Product product, bool excludeProperties = false);
        ...
        RelatedProductListModel PrepareRelatedProductListModel(RelatedProductSearchModel searchModel, Core.Domain.Catalog.Product product);
        ...
        CrossSellProductListModel PrepareCrossSellProductListModel(CrossSellProductSearchModel searchModel, Core.Domain.Catalog.Product product);
        ...
        AssociatedProductListModel PrepareAssociatedProductListModel(AssociatedProductSearchModel searchModel, Core.Domain.Catalog.Product product);
        ...
        ProductPictureListModel PrepareProductPictureListModel(ProductPictureSearchModel searchModel, Core.Domain.Catalog.Product product);
        ...
        ProductOrderListModel PrepareProductOrderListModel(ProductOrderSearchModel searchModel, Core.Domain.Catalog.Product product);
        ...
        ExtendedBulkEditProductSearchModel PrepareExtendedBulkEditProductSearchModel(
        ...
        ExtendedBulkEditProductListModel PrepareExtendedBulkEditProductListModel(ExtendedBulkEditProductSearchModel searchModel);
        ...
        TierPriceListModel PrepareTierPriceListModel(TierPriceSearchModel searchModel, Core.Domain.Catalog.Product product);
        ...
        StockQuantityHistoryListModel PrepareStockQuantityHistoryListModel(StockQuantityHistorySearchModel searchModel, Core.Domain.Catalog.Product product);
        ...
        ProductAttributeMappingModel PrepareProductAttributeMappingModel(ProductAttributeMappingModel model,
            Core.Domain.Catalog.Product product, ProductAttributeMapping productAttributeMapping, bool excludeProperties = false);
        ...
        ProductAttributeCombinationModel PrepareProductAttributeCombinationModel(ProductAttributeCombinationModel model,
            Core.Domain.Catalog.Product product, ProductAttributeCombination productAttributeCombination, bool excludeProperties = false);
    }
}