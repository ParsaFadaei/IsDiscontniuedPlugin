...
namespace Nop.Plugin.Product.Discontinued.Factories.Customer
{
    ...
    /// </summary>
    public interface IProductCustomerModelFactory
    {
        /// <summary>
        ...
        string PrepareProductTemplateViewPath(Core.Domain.Catalog.Product product);
        ...
        IEnumerable<ProductOverviewModel> PrepareProductOverviewModels(IEnumerable<Core.Domain.Catalog.Product> products,
        ...
        ProductDetailsModel PrepareProductDetailsModel(Core.Domain.Catalog.Product product, ShoppingCartItem updatecartitem = null, bool isAssociatedProduct = false);
        ProductDetailsModel PrepareDiscontinuedProductDetailsModel(Core.Domain.Catalog.Product product, ShoppingCartItem updatecartitem = null, bool isAssociatedProduct = false);
        ...
        ProductReviewsModel PrepareProductReviewsModel(ProductReviewsModel model, Core.Domain.Catalog.Product product);
        ...
        ProductEmailAFriendModel PrepareProductEmailAFriendModel(ProductEmailAFriendModel model, Core.Domain.Catalog.Product product, bool excludeProperties);
        ...
        IList<ProductSpecificationModel> PrepareProductSpecificationModel(Core.Domain.Catalog.Product product);
    }
}
