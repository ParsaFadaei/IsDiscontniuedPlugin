...
namespace Nop.Plugin.Product.Discontinued.Factories.Customer
{
    /// <summary>
    /// Represents the product model factory
    /// </summary>
    public class ProductCustomerModelFactory : IProductCustomerModelFactory
    {
        #region Fields
        ...
        public ProductCustomerModelFactory(IDiscontinuedService discontinuedService, CaptchaSettings captchaSettings,
        ...
        protected virtual ProductReviewOverviewModel PrepareProductReviewOverviewModel(Core.Domain.Catalog.Product product)
        {
        ...
        protected virtual ProductOverviewModel.ProductPriceModel PrepareProductOverviewPriceModel(Core.Domain.Catalog.Product product, bool forceRedirectionAfterAddingToCart = false)
        {
            if (product == null)
        ...
        protected virtual void PrepareSimpleProductOverviewPriceModel(Core.Domain.Catalog.Product product, ProductOverviewModel.ProductPriceModel priceModel)
        {
            //add to cart button
        ...
        protected virtual void PrepareGroupedProductOverviewPriceModel(Core.Domain.Catalog.Product product, ProductOverviewModel.ProductPriceModel priceModel)
        {
            ...
            if (_permissionService.Authorize(StandardPermissionProvider.DisplayPrices))
            {
                ...
                Core.Domain.Catalog.Product minPriceProduct = null;
        ...
        protected virtual PictureModel PrepareProductOverviewPictureModel(Core.Domain.Catalog.Product product, int? productThumbPictureSize = null)
        {
            if (product == null)
                throw new ArgumentNullException(nameof(product));
        ...
        protected virtual ProductDetailsModel.ProductBreadcrumbModel PrepareProductBreadcrumbModel(Core.Domain.Catalog.Product product)
        {
            if (product == null)
                throw new ArgumentNullException(nameof(product));
        ...
        protected virtual IList<ProductTagModel> PrepareProductTagModels(Core.Domain.Catalog.Product product)
        {
            if (product == null)
                throw new ArgumentNullException(nameof(product));
        ...
        protected virtual ProductDetailsModel.ProductPriceModel PrepareProductPriceModel(Core.Domain.Catalog.Product product)
        {
            if (product == null)
                throw new ArgumentNullException(nameof(product));
        ...
        protected virtual ProductDetailsModel.AddToCartModel PrepareProductAddToCartModel(Core.Domain.Catalog.Product product, ShoppingCartItem updatecartitem)
        {
            if (product == null)
                throw new ArgumentNullException(nameof(product));
        ...
        protected virtual IList<ProductDetailsModel.ProductAttributeModel> PrepareProductAttributeModels(Core.Domain.Catalog.Product product, ShoppingCartItem updatecartitem)
        {
            if (product == null)
                throw new ArgumentNullException(nameof(product));
        ...
        protected virtual IList<ProductDetailsModel.TierPriceModel> PrepareProductTierPriceModels(Core.Domain.Catalog.Product product)
        {
            if (product == null)
                throw new ArgumentNullException(nameof(product));
        ...
        protected virtual IList<ManufacturerBriefInfoModel> PrepareProductManufacturerModels(Core.Domain.Catalog.Product product)
        {
            if (product == null)
                throw new ArgumentNullException(nameof(product));
        ...
        protected virtual PictureModel PrepareProductDetailsPictureModel(Core.Domain.Catalog.Product product, bool isAssociatedProduct, out IList<PictureModel> allPictureModels)
        {
            if (product == null)
                throw new ArgumentNullException(nameof(product));
        ...
        public virtual string PrepareProductTemplateViewPath(Core.Domain.Catalog.Product product)
        {
            if (product == null)
                throw new ArgumentNullException(nameof(product));
        ...
        public virtual IEnumerable<ProductOverviewModel> PrepareProductOverviewModels(IEnumerable<Core.Domain.Catalog.Product> products,
        ...
        public virtual ProductDetailsModel PrepareProductDetailsModel(Core.Domain.Catalog.Product product,
        ...
        //PLUGIN
        public ProductDetailsModel PrepareDiscontinuedProductDetailsModel(Core.Domain.Catalog.Product product,
            ShoppingCartItem updatecartitem = null, bool isAssociatedProduct = false)
        {
            if (product == null)
                throw new ArgumentNullException(nameof(product));
            ...
            //standard properties
            var model = new ProductCustomerDiscontinuedModel()
            {
                Id = product.Id,
                Name = _localizationService.GetLocalized(product, x => x.Name),
                ShortDescription = _localizationService.GetLocalized(product, x => x.ShortDescription),
        ...
        public virtual ProductReviewsModel PrepareProductReviewsModel(ProductReviewsModel model, Core.Domain.Catalog.Product product)
        {
            if (model == null)
        ...
        public virtual ProductEmailAFriendModel PrepareProductEmailAFriendModel(ProductEmailAFriendModel model, Core.Domain.Catalog.Product product, bool excludeProperties)
        {
            if (model == null)
                throw new ArgumentNullException(nameof(model));
        ...
        public virtual IList<ProductSpecificationModel> PrepareProductSpecificationModel(Core.Domain.Catalog.Product product)
        {
            if (product == null)
                throw new ArgumentNullException(nameof(product));
