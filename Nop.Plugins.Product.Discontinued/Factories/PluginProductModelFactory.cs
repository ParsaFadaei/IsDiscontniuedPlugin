...
namespace Nop.Plugin.Product.Discontinued.Factories
{
    public class PluginProductModelFactory : IPluginProductModelFactory
    {
        #region stuff
        ...
        protected virtual CopyProductModel PrepareCopyProductModel(CopyProductModel model,
            Core.Domain.Catalog.Product product)
        {
            ...
            model.Id = product.Id;
            model.Name = string.Format(_localizationService.GetResource("Admin.Catalog.Products.Copy.Name.New"),
                product.Name);
        ...
        protected virtual void PrepareProductWarehouseInventoryModels(IList<ProductWarehouseInventoryModel> models,
            Core.Domain.Catalog.Product product)
        {
            if (models == null)
            ...
            foreach (var warehouse in _shippingService.GetAllWarehouses())
            {
                ...
                if (productWarehouseInventory != null)
                {
                    ...
                    model.PlannedQuantity = _shipmentService.GetQuantityInShipments(product,
            ...
            AddSpecificationAttributeToProductModel model)
        {
            ...
            if (model.AvailableAttributes.Any() && int.TryParse(model.AvailableAttributes.FirstOrDefault()?.Value,
                out var selectedAttributeId))
            {
        ...
        protected virtual string PrepareProductAttributeMappingValidationRulesString(
            ...
            ProductAttributeMapping productAttributeMapping)
        {
            ...
            var attributes = _productAttributeService
                .GetProductAttributeMappingsByProductId(productAttributeMapping.ProductId)
        ...
        protected virtual RelatedProductSearchModel PrepareRelatedProductSearchModel(
            RelatedProductSearchModel searchModel, Core.Domain.Catalog.Product product)
        {
            if (searchModel == null)
        ...
        protected virtual CrossSellProductSearchModel PrepareCrossSellProductSearchModel(
            CrossSellProductSearchModel searchModel, Core.Domain.Catalog.Product product)
        {
            if (searchModel == null)
                throw new ArgumentNullException(nameof(searchModel));
        ...
        protected virtual AssociatedProductSearchModel PrepareAssociatedProductSearchModel(
            AssociatedProductSearchModel searchModel, Core.Domain.Catalog.Product product)
        {
            if (searchModel == null)
                throw new ArgumentNullException(nameof(searchModel));
        ...
        protected virtual ProductPictureSearchModel PrepareProductPictureSearchModel(
            ProductPictureSearchModel searchModel, Core.Domain.Catalog.Product product)
        {
            if (searchModel == null)
                throw new ArgumentNullException(nameof(searchModel));
        ...
        protected virtual StockQuantityHistorySearchModel PrepareStockQuantityHistorySearchModel(
            StockQuantityHistorySearchModel searchModel, Core.Domain.Catalog.Product product)
        {
            if (searchModel == null)
                throw new ArgumentNullException(nameof(searchModel));
        ...
        protected virtual ProductAttributeCombinationSearchModel PrepareProductAttributeCombinationSearchModel(
            ProductAttributeCombinationSearchModel searchModel, Core.Domain.Catalog.Product product)
        {
            if (searchModel == null)
                throw new ArgumentNullException(nameof(searchModel));
        ...
        protected virtual ProductSpecificationAttributeSearchModel PrepareProductSpecificationAttributeSearchModel(
            ProductSpecificationAttributeSearchModel searchModel, Core.Domain.Catalog.Product product)
        {
            if (searchModel == null)
                throw new ArgumentNullException(nameof(searchModel));
        ...
        public virtual ProductListModel PrepareProductListModel(ProductSearchModel searchModel)
        {
            ...
            if (searchModel.SearchIncludeSubCategories && searchModel.SearchCategoryId > 0)
            {
                var childCategoryIds =
                    _categoryService.GetChildCategoryIds(parentCategoryId: searchModel.SearchCategoryId,
                        showHidden: true);
        ...
        public ProductModel PrepareProductModel(ProductModel model, Core.Domain.Catalog.Product product,
            bool excludeProperties = false)
        {
            ...
            if (product != null)
            {
                ...
                model.ProductTags = string.Join(", ",
                    _productTagService.GetAllProductTagsByProductId(product.Id).Select(tag => tag.Name));
                ...
                if (!excludeProperties)
                {
                    ...
                    model.SelectedManufacturerIds = _manufacturerService
                ...
                {
                    locale.Name =
                        _localizationService.GetLocalized(product, entity => entity.Name, languageId, false, false);
                    locale.FullDescription = _localizationService.GetLocalized(product,
                        entity => entity.FullDescription, languageId, false, false);
                    locale.ShortDescription = _localizationService.GetLocalized(product,
                        entity => entity.ShortDescription, languageId, false, false);
                    locale.MetaKeywords = _localizationService.GetLocalized(product, entity => entity.MetaKeywords,
                        languageId, false, false);
                    locale.MetaDescription = _localizationService.GetLocalized(product,
                        entity => entity.MetaDescription, languageId, false, false);
                    locale.MetaTitle = _localizationService.GetLocalized(product, entity => entity.MetaTitle,
                        languageId, false, false);
            ...
            _baseAdminModelFactory.PrepareProductAvailabilityRanges(model.AvailableProductAvailabilityRanges,
                defaultItemText: _localizationService.GetResource(
        ...
        public ProductDiscontinuedModel PreparePluginProductModel(ProductDiscontinuedModel model, Core.Domain.Catalog.Product product,
            bool excludeProperties = false)
        {
            Action<ProductLocalizedModel, int> localizedModelConfiguration = null;
            ...
            {
                //fill in model values from the entity
                model = model ?? product.ToModel<ProductDiscontinuedModel>();
        ...
        public virtual AddRequiredProductSearchModel PrepareAddRequiredProductSearchModel(
        ...
        public virtual AddRequiredProductListModel PrepareAddRequiredProductListModel(
            AddRequiredProductSearchModel searchModel)
        {
            if (searchModel == null)
                throw new ArgumentNullException(nameof(searchModel));
        ...
        public virtual RelatedProductListModel PrepareRelatedProductListModel(RelatedProductSearchModel searchModel,
            Core.Domain.Catalog.Product product)
        {
            if (searchModel == null)
                throw new ArgumentNullException(nameof(searchModel));
            ...
            var relatedProducts =
                _productService.GetRelatedProductsByProductId1(productId1: product.Id, showHidden: true);
        ...
        public virtual AddRelatedProductSearchModel PrepareAddRelatedProductSearchModel(
        ...
        public virtual AddRelatedProductListModel PrepareAddRelatedProductListModel(
            AddRelatedProductSearchModel searchModel)
        {
            if (searchModel == null)
                throw new ArgumentNullException(nameof(searchModel));
        ...
        public virtual CrossSellProductListModel PrepareCrossSellProductListModel(
            CrossSellProductSearchModel searchModel, Core.Domain.Catalog.Product product)
        {
            if (searchModel == null)
                throw new ArgumentNullException(nameof(searchModel));
            ...
            var crossSellProducts =
                _productService.GetCrossSellProductsByProductId1(productId1: product.Id, showHidden: true);
            ...
            var model = new CrossSellProductListModel
            {
                Data = crossSellProducts.PaginationByRequestModel(searchModel).Select(crossSellProduct =>
                {
                    ...
                    crossSellProductModel.Product2Name =
                        _productService.GetProductById(crossSellProduct.ProductId2)?.Name;
        ...
        public virtual AddCrossSellProductSearchModel PrepareAddCrossSellProductSearchModel(
        ...
        public virtual AddCrossSellProductListModel PrepareAddCrossSellProductListModel(
            AddCrossSellProductSearchModel searchModel)
        {
            if (searchModel == null)
                throw new ArgumentNullException(nameof(searchModel));
        ...
        public virtual AssociatedProductListModel PrepareAssociatedProductListModel(
            AssociatedProductSearchModel searchModel, Core.Domain.Catalog.Product product)
        {
            if (searchModel == null)
                throw new ArgumentNullException(nameof(searchModel));
        ...
        public virtual AddAssociatedProductSearchModel PrepareAddAssociatedProductSearchModel(
        ...
        public virtual AddAssociatedProductListModel PrepareAddAssociatedProductListModel(
            AddAssociatedProductSearchModel searchModel)
        {
            if (searchModel == null)
                throw new ArgumentNullException(nameof(searchModel));
        ...
        public virtual ProductPictureListModel PrepareProductPictureListModel(ProductPictureSearchModel searchModel,
            Core.Domain.Catalog.Product product)
        {
            if (searchModel == null)
                throw new ArgumentNullException(nameof(searchModel));
            ...
            ProductSpecificationAttributeSearchModel searchModel, Core.Domain.Catalog.Product product)
        {
            ...
            var productSpecificationAttributes =
                _specificationAttributeService.GetProductSpecificationAttributes(product.Id);
            ...
            var model = new ProductSpecificationAttributeListModel
            {
                Data = productSpecificationAttributes.PaginationByRequestModel(searchModel).Select(attribute =>
                {
                    ...
                    productSpecificationAttributeModel.AttributeTypeName =
                        _localizationService.GetLocalizedEnum(attribute.AttributeType);
                    productSpecificationAttributeModel.AttributeId =
                        attribute.SpecificationAttributeOption.SpecificationAttribute.Id;
                    productSpecificationAttributeModel.AttributeName =
                        attribute.SpecificationAttributeOption.SpecificationAttribute.Name;
                    switch (attribute.AttributeType)
                    {
                        case SpecificationAttributeType.Option:
                            productSpecificationAttributeModel.ValueRaw =
                                WebUtility.HtmlEncode(attribute.SpecificationAttributeOption.Name);
        ...
        public virtual ProductTagModel PrepareProductTagModel(ProductTagModel model, ProductTag productTag,
            bool excludeProperties = false)
        {
            ...
            if (productTag != null)
            {
                ...
                localizedModelConfiguration = (locale, languageId) =>
                {
                    locale.Name = _localizationService.GetLocalized(productTag, entity => entity.Name, languageId,
                        false, false);
                };
            }
        ...
        public virtual ProductOrderListModel PrepareProductOrderListModel(ProductOrderSearchModel searchModel,
            Core.Domain.Catalog.Product product)
        {
            if (searchModel == null)
                throw new ArgumentNullException(nameof(searchModel));
        ...
        public virtual BulkEditProductSearchModel PrepareBulkEditProductSearchModel(
            BulkEditProductSearchModel searchModel)
        {
            if (searchModel == null)
                throw new ArgumentNullException(nameof(searchModel));
        ...
        ///PLUGIN
        public ExtendedBulkEditProductSearchModel PrepareExtendedBulkEditProductSearchModel(
            ExtendedBulkEditProductSearchModel searchModel)
        {
            if (searchModel == null)
                throw new ArgumentNullException(nameof(searchModel));
        ...
        public virtual BulkEditProductListModel PrepareBulkEditProductListModel(BulkEditProductSearchModel searchModel)
        {
            ...
            var model = new BulkEditProductListModel
            {
                Data = products.Select(product =>
                {
                    ...
                    //fill in additional values (not existing in the entity)
                    productModel.ManageInventoryMethod =
                        _localizationService.GetLocalizedEnum(product.ManageInventoryMethod);
                    if (product.ManageInventoryMethod == ManageInventoryMethod.ManageStock &&
                        product.UseMultipleWarehouses)
                    {
                        productModel.ManageInventoryMethod =
                            $"{productModel.ManageInventoryMethod} {_localizationService.GetResource("Admin.Catalog.BulkEdit.Fields.ManageInventoryMethod.MultipleWarehouse")}";
                    }
        ...
        public ExtendedBulkEditProductListModel PrepareExtendedBulkEditProductListModel(ExtendedBulkEditProductSearchModel searchModel)
        {
            if (searchModel == null)
                throw new ArgumentNullException(nameof(searchModel));
        ...
        public virtual TierPriceListModel PrepareTierPriceListModel(TierPriceSearchModel searchModel,
            Core.Domain.Catalog.Product product)
        {
            if (searchModel == null)
                throw new ArgumentNullException(nameof(searchModel));
        ...
        public virtual TierPriceModel PrepareTierPriceModel(TierPriceModel model,
            Core.Domain.Catalog.Product product, TierPrice tierPrice, bool excludeProperties = false)
        {
            if (product == null)
                throw new ArgumentNullException(nameof(product));
        ...
        public virtual StockQuantityHistoryListModel PrepareStockQuantityHistoryListModel(
            StockQuantityHistorySearchModel searchModel, Core.Domain.Catalog.Product product)
        {
            if (searchModel == null)
                throw new ArgumentNullException(nameof(searchModel));
        ...
        public virtual ProductAttributeMappingListModel PrepareProductAttributeMappingListModel(
            ProductAttributeMappingSearchModel searchModel,
            Core.Domain.Catalog.Product product)
        {
            if (searchModel == null)
            ...
            var model = new ProductAttributeMappingListModel
            {
                Data = productAttributeMappings.PaginationByRequestModel(searchModel).Select(attributeMapping =>
                {
                    ...
                    productAttributeMappingModel.ValidationRulesString =
                        PrepareProductAttributeMappingValidationRulesString(attributeMapping);
                    ...
                    productAttributeMappingModel.AttributeControlType =
                        _localizationService.GetLocalizedEnum(attributeMapping.AttributeControlType);
        ...
        public virtual ProductAttributeMappingModel PrepareProductAttributeMappingModel(
            ProductAttributeMappingModel model,
            Core.Domain.Catalog.Product product, ProductAttributeMapping productAttributeMapping,
            bool excludeProperties = false)
        {
            ...
            if (productAttributeMapping != null)
            {
                ...
                model.ProductAttribute = _productAttributeService
                    .GetProductAttributeById(productAttributeMapping.ProductAttributeId).Name;
                model.AttributeControlType =
                    _localizationService.GetLocalizedEnum(productAttributeMapping.AttributeControlType);
                ...
                localizedModelConfiguration = (locale, languageId) =>
                {
                    locale.TextPrompt = _localizationService.GetLocalized(productAttributeMapping,
            ...
            model.AvailableProductAttributes = _productAttributeService.GetAllProductAttributes().Select(
                productAttribute => new SelectListItem
                {
        ...
        public virtual ProductAttributeValueListModel PrepareProductAttributeValueListModel(
            ProductAttributeValueSearchModel searchModel,
            ProductAttributeMapping productAttributeMapping)
        {
            if (searchModel == null)
            ...
            var model = new ProductAttributeValueListModel
            {
                Data = productAttributeValues.PaginationByRequestModel(searchModel).Select(value =>
                {
                    ...
                    productAttributeValueModel.AttributeValueTypeName =
                        _localizationService.GetLocalizedEnum(value.AttributeValueType);
                    productAttributeValueModel.Name = value.ProductAttributeMapping.AttributeControlType !=
                    ...
                    if (value.AttributeValueType == AttributeValueType.AssociatedToProduct)
                    {
                        productAttributeValueModel
                            ...
                            _productService.GetProductById(value.AssociatedProductId)?.Name ??
                            string.Empty;
                    }
            ...
            if (productAttributeValue != null)
            {
                ...
                model = model ?? new ProductAttributeValueModel
                {
                    ...
                    AttributeValueTypeName =
                        _localizationService.GetLocalizedEnum(productAttributeValue.AttributeValueType),
                ...
                model.AssociatedProductName =
                    _productService.GetProductById(productAttributeValue.AssociatedProductId)?.Name;

                //define localized model configuration action
                localizedModelConfiguration = (locale, languageId) =>
                {
                    locale.Name = _localizationService.GetLocalized(productAttributeValue, entity => entity.Name,
                        languageId, false, false);
                };
            }
            ...
            var model = new ProductAttributeCombinationListModel
            {
                Data = productAttributeCombinations.PaginationByRequestModel(searchModel).Select(combination =>
                {
                    ...
                    productAttributeCombinationModel.AttributesXml = _productAttributeFormatter
                        .FormatAttributes(combination.Product, combination.AttributesXml, _workContext.CurrentCustomer,
                    ...
                    var warnings = _shoppingCartService.GetShoppingCartItemAttributeWarnings(
                        ...
                        ignoreNonCombinableAttributes: true).Aggregate(string.Empty,
                        (message, warning) => $"{message}{warning}<br />");
        ...
        public virtual ProductAttributeCombinationModel PrepareProductAttributeCombinationModel(
            ProductAttributeCombinationModel model,
            Core.Domain.Catalog.Product product, ProductAttributeCombination productAttributeCombination,
            bool excludeProperties = false)
        {
            if (product == null)
                throw new ArgumentNullException(nameof(product));
